                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Dashboard
                                        <div class="page-title-subheading">This is dashboard for shortcut action.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Ebook</div>
                                            <div class="widget-subheading">All book in website</div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Catetegory</div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Author</div>
                                            <div class="widget-subheading">Total Author</div>
                                        </div>
                                        <div class="widget-content-right">
                                    ...
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link">
                                               Copyright © 2022 SOUTRUOSHIM All right reversed.
                                            </a>
                                        </li>
                                    </ul>
                                </div>
...
<script type="text/javascript" src="libs/assets/scripts/main.js"></script>
